...
public interface ITryDatabaseFrameworkAndBindingRepository
{
	#region GET
	...
	Task<IEnumerable<IItemDTO>> InsertModelWithEntityFrameworkAndLinqAsync();
	...
	Task<IEnumerable<IItemDTO>> UpdateModelWithEntityFrameworkAndLinqAsync();
	...
	Task<IEnumerable<IItemDTO>> UpdateBulkModelWithEntityFrameworkAndLinqAsync();
	...
	Task<IEnumerable<IItemDTO>> DeleteModelWithEntityFrameworkAndLinqAsync();
	...
	Task<IEnumerable<IItemDTO>> DeleteBulkModelWithEntityFrameworkAndLinqAsync();
